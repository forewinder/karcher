...
if ($sess){
	...
	// 최근 주소지
	$lastDelivery = "
		SELECT nameReceiver AS last_name, road_address AS last_road_address, zipcode AS last_zipcode, address AS last_address, phoneReceiver AS last_phone, mobileReceiver AS last_mobile, memo AS last_memo, zonecode AS last_zonecode
		FROM ".GD_ORDER."
