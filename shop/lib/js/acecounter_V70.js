var _JV="AMZ201211052";//script Version 주문번호추가 ,DMP 추가
...
function _uAcid_20151126(a1,a2,b1,c1){try{var _CRG=a2.substr(0,a2.indexOf('.'));var cS = document.createElement('script');var cH = document.getElementsByTagName("head")[0];if(String(document.cookie).indexOf('ACEUCI')==-1){cS.async = true;cS.type = 'text/javascript';cS.src = location.protocol + "//cr.acecounter.com/uacid.js?gc="+a1+"&py="+c1+"&gd="+_CRG+"&gp="+b1+"&up=NaPm_Ncisy&rd="+(new Date().getTime()); cH.appendChild(cS);} }catch(_e){ } }
...
_uAcid_20151126(EL_GCD,EL_GUL,EL_GPT,_mset);
