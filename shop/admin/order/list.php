...
<tr>
	...
	<input type="checkbox" name="chk_inflow[]" value="naverCheckout" <?=(in_array('naverCheckout',$search['chk_inflow'])?'checked':'')?>><img src="../img/inflow_naverCheckout.gif" align="absmiddle"/> 네이버페이</input>
