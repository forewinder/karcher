	...
	<tr>
		...
		<td>
			...
			<tr class="ac">
				...
				<th style="width:20%">옵션값</th>
				<th style="width:20%">옵션금액</th>
...
<!-- S: 상품 설명 -->
	...
	<tr>
		...
		<td>
			...
			<textarea name="shortdesc" style="width:100%;height:150px;overflow:visible" class=tline type="editor"><?=$goods[shortdesc]?></textarea>
		</td>
	</tr>
...
<!-- S: 메인 팝업 -->
	<h2 class="title">메인 팝업 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=product&no=3');"><img src="../img/btn_q.gif" border="0" align="absmiddle" hspace="2" /></a></h2>
	<table class="admin-form-table">
	<tr>
		<th>사용설정</th>
		<td>
			<?php
			foreach ($form->getTag('main_popup_useyn') as $label => $tag) {
				echo sprintf('<label>%s%s</label> ',$tag, $label);
			}
			?>
			<p class="help">
	...
	<tr>
		...
		<td>
			<div class="field-wrapper">
			<!--<?=$form->getTag('memo'); ?> -->
			<textarea name="mainpopupdesc" style="width:100%;height:300px" type=editor><?=$goods[mainpopupdesc]?></textarea>
			</div>
		</td>
	</tr>
	</table>
