<?php /* Template_ 2.2.7 2015/12/28 15:21:51 /www/hummingimc_godo_co_kr/shop/data/skin/standard/mypage/mypage_review.htm 000004960 */ 
...
<tr>
	<td><img src="/shop/data/skin/standard/img/common/title_myreview.gif" border=0></td>
</tr>
<TR>
...
<tr height=25 onmouseover=this.style.background="#F7F7F7" onmouseout=this.style.background="">
	...
	<tr>
		<td style="padding-top:5; padding-bottom:5" class=stxt><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["attach"]){?>&nbsp;&nbsp;<img src="/shop/data/skin/standard/img/disk_icon.gif" align="absmiddle"><?php }?></td>
	</tr>
	</TABLE>
	</td>
