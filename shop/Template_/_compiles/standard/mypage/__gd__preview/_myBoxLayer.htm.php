<?php /* Template_ 2.2.7 2015/12/28 15:21:51 /www/hummingimc_godo_co_kr/shop/data/skin/standard/mypage/_myBoxLayer.htm 000004582 */ ?>
...
<?php if($GLOBALS["sess"]["grpnm_disp_type"]=='icon'){?><img src="../data/member/icon/<?php echo $GLOBALS["sess"]["grpnm_icon"]?>" align="absbottom"><?php }?>
	...
	<div>
		<a href="<?php echo url("mypage/mypage.php")?>&"><img src="/shop/data/skin/standard/img/main/btn_mypage_go.gif"></a>
	</div>
