<?php /* Template_ 2.2.7 2015/02/02 16:20:58 /www/hummingimc_godo_co_kr/shop/data/skin/standard/proc/popup_coupon.htm 000008032 */ ?>
...
<tr>
	<td style="background:#000000; border-bottom:2px solid #DDDDDD; height:40px;"><img src="/shop/data/skin/standard/img/common/popup_title_coupon.gif"></td>
</tr>
<tr>
...
<?php }}?>
	...
	<div style="padding:10px" align=center><a href="javascript:window.close()"><img src="/shop/data/skin/standard/img/common/btn_confirm_red.gif"></a></div>
	</td>
</tr>
...
<tr>
	<td valign=bottom align=right style="padding:0 14 6 0;">
		...
		* 아래와 같이 정상 결제되지 않은 경우 사용된 쿠폰을 미사용 상태로 변경하여 재사용하실 수 있습니다.<br />
		...
		<A HREF="javascript:this.close()" onFocus="blur()"><img src="/shop/data/skin/standard/img/common/popup_close.gif"></A>
	</td>
</tr>
</table>
</body>
