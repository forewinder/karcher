<?php /* Template_ 2.2.7 2016/02/05 10:39:07 /www/hummingimc_godo_co_kr/shop/data/skin/standard/order/order.htm 000046945 */  $this->include_("displayEggBanner");
...
<?php if($GLOBALS["sess"]){?>
	<tr>
		...
		<td class="noline">
			...
			<a href="javascript:popup('./order_delivery.php?mode=list&pkind=p',700,550)"><img src="/shop/data/skin/standard/img/common/btn_delivery_list.png" title="배송지 목록" alt="배송지 목록" style="vertical-align:bottom" /></a>
		</td>
	</tr>
<?php }else{?>
	<tr>
...
<?php }?>
	...
	<tr>
		...
		<a href="javascript:popup('../proc/popup_address.php',500,432);" id="addressSearch" <?php if($GLOBALS["sess"]){?>style="display:none;"<?php }?>><img src="/shop/data/skin/standard/img/common/btn_zipcode.gif" align=absmiddle></a>
		</td>
	</tr>
	<tr>
		<td></td>
...
function last_field() 
{
	...
	form.memo.value = "<?php echo $TPL_VAR["last_memo"]?>";
