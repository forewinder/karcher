<?php /* Template_ 2.2.7 2015/11/03 13:30:08 /www/hummingimc_godo_co_kr/shop/data/skin/standard/member/_form.htm 000039642 */ 
...
<div><img src="/shop/data/skin/standard/img/common/join_txt_04.gif" border=0 align=absmiddle><font color=FF6000 >* </font><font class=small><b>필수입력사항</b></font></div>
...
<?php if(!$GLOBALS["sess"]){?>
	...
	<a href="javascript:chkId()"><img src="/shop/data/skin/standard/img/common/btn_idcheck.gif" border=0 align=absmiddle></a>
<?php }else{?>
...
<tr>
	...
	<!-- 비밀번호 버튼 -->
	<td class="memberCols2">
		<a href="javascript:void(0);" onclick="openPasswordField()"><img src="/shop/data/skin/standard/img/common/btn_change_pwd.gif" align="absmiddle" alt="비밀번호 변경" /></a>
		<a href="javascript:void(0);" onclick="_ID('pwdManual').style.display='block';"><img src="/shop/data/skin/standard/img/common/btn_help_pwd.gif" align="absmiddle" alt="비밀번호 도움말" /></a><br />
		<!-- 비밀번호 도움말 -->
		<div id="pwdManual">
			<p>
			...
			<p class="close">
				<a href="javascript:void(0);" onclick="_ID('pwdManual').style.display='none';"><img src="/shop/data/skin/standard/img/common/close_x.gif" /></a>
			</p>
		</div>
	</td>
</tr>
...
<tr>
	...
	<a href="javascript:chkNickname()"><img src="/shop/data/skin/standard/img/common/btn_nickcheck.gif" border=0 align=absmiddle></a>
	</td>
</tr>
<tr><td colspan=2 height=1 bgcolor="#DEDEDE" style="padding:0px;"></td></tr>
<?php }?>
...
<?php if(!$GLOBALS["sess"]){?><input type=hidden name=chk_email <?php echo $GLOBALS["required"]["email"]?> label="이메일중복체크"><?php }?>
	<a href="javascript:void(0)" onClick="chkEmail()"><img src="/shop/data/skin/standard/img/common/btn_mailcheck.gif" border=0 align=absmiddle></a>
...
<tr>
	...
	<tr>
		...
		<a href="javascript:popup('../proc/popup_address.php',500,432)"><img src="/shop/data/skin/standard/img/common/btn_zipcode.gif" border=0 align=absmiddle></a>
		</td>
	</tr>
	<tr>
		<td>
...
<?php if($TPL_VAR["hpauthDreamyn"]=='y'&&$TPL_VAR["hpauthDreammoduseyn"]=='y'){?><a onclick="gohpauthDream()" style="cursor:pointer;"><img src="/shop/data/skin/standard/img/common/btn_change_handphone.gif" border=0 align=absmiddle></a><?php }?>
...
<div style="width:100%" class=noline><input type=image src="/shop/data/skin/standard/img/common/btn_join.gif">
<img src="/shop/data/skin/standard/img/common/btn_back.gif" border=0 onClick="history.back()" style="cursor:pointer;"></div>
</td>
</tr>
</table>
<?php }else{?>
...
<tr>
<td id=avoidDbl align=center height=100>
<div style="width:100%" class=noline><input type=image src="/shop/data/skin/standard/img/common/btn_modify_info.gif">
<img src="/shop/data/skin/standard/img/common/btn_back.gif" border=0 onClick="history.back()" style="cursor:pointer;"></div>
</td>
</tr>
</table>
