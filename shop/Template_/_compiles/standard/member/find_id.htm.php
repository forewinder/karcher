<?php /* Template_ 2.2.7 2014/09/03 11:02:59 /www/hummingimc_godo_co_kr/shop/data/skin/standard/member/find_id.htm 000006167 */ ?>
...
<tr>
	<td><img src="/shop/data/skin/standard/img/common/title_idsearch.gif" border=0></td>
</tr>
<TR>
...
<div><img src="/shop/data/skin/standard/img/common/id_01.gif" border=0></div>
<div style="border:1px solid #DEDEDE;" class="hundred">
<table width=100% cellpadding=0 cellspacing=0 border=0>
<tr>
	<td style="border:5px solid #F3F3F3;padding:10;">
		<div style="float:left; width:130"><img src="/shop/data/skin/standard/img/common/id_02.gif" border=0></div>
		...
		<tr>
			...
			<td rowspan=3 class=noline><input type="image" src="/shop/data/skin/standard/img/common/id_btn.gif" tabindex=6></td>
		</tr>
...
<tr>
	<td style="border:5px solid #F3F3F3;padding:10;">
		...
		<tr>
			<td><br>
			<img src="/shop/data/skin/standard/img/ipin/Regist_box_icon.gif"/> <font color='5d5d5d'>회원 가입시 사용 하신 본인확인 인증 수단을 선택하시고 필요한 사항을 입력하세요 <br></font>
		</td>
		</tr>
		<tr height="10">
			<td></td>
...
<?php if($TPL_VAR["ipinyn"]=='y'||$TPL_VAR["niceipinyn"]=='y'){?>
				...
				<img src="/shop/data/skin/standard/img/ipin/ipin_btn.gif" onclick="goIDCheckIpin();" style="cursor:pointer;">
				<iframe id="ifrmRnCheck" name="ifrmRnCheck" style="width:500px;height:500px;display:none;"></iframe>
				</span>
<?php }?>
<?php if($TPL_VAR["hpauthDreamyn"]=='y'){?>
				<span>
				<img src="/shop/data/skin/standard/img/auth/hp_btn.gif" alt="휴대폰본인인증" onclick="gohpauthDream();" style="cursor:pointer;">
...
<a href="<?php echo url("member/find_pwd.php")?>&"><img src="/shop/data/skin/standard/img/common/id_btn_pw.gif"></a>&nbsp;
<a href="<?php echo url("member/login.php")?>&"><img src="/shop/data/skin/standard/img/common/id_btn_login.gif"></a>
</div>
...
<div style="text-align:center; padding-top:20"><a href="<?php echo url("member/find_id.php")?>&"><img src="/shop/data/skin/standard/img/common/btn_research.gif"></a></div>
...
<div style="text-align:center; padding-top:20"><a href="<?php echo url("member/login.php")?>&"><img src="/shop/data/skin/standard/img/common/id_btn_login.gif"></a> <a href="<?php echo url("member/find_pwd.php")?>&"><img src="/shop/data/skin/standard/img/common/id_btn_pw.gif"></a></div>
