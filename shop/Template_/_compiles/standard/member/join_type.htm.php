<?php /* Template_ 2.2.7 2015/03/02 10:30:53 /www/hummingimc_godo_co_kr/shop/data/skin/standard/member/join_type.htm 000003708 */ ?>
...
div.join-member-title {
	...
	margin-top: 5px;
	margin-bottom: 5px;
	background: url('/shop/data/skin/standard/img/join_title_01.gif') no-repeat;
	height: 23px;
	font-size: 0;
	text-indent: -9999px;
	display: block;
...
div.join-shop div.join-shop-title {
	height: 12px;
	background: url('/shop/data/skin/standard/img/sns_join_01.gif') no-repeat;
	font-size: 0;
	text-indent: -9999px;
	display: block;
}
...
div.join-shop div.join-shop-select button.btn-join-shop {
	width: 219px;
	height: 54px;
	background: url('/shop/data/skin/standard/img/btn_shop_join.gif') no-repeat;
	border: none;
	font-size: 0;
	text-indent: -9999px;
	display: block;
...
div.join-sns div.join-sns-title {
	height: 12px;
	background: url('/shop/data/skin/standard/img/sns_join_02.gif') no-repeat;
	font-size: 0;
	text-indent: -9999px;
	display: block;
}
...
div.join-sns div.join-sns-select div.sns-btn-group button.btn-facebook {
	width: 125px;
	height: 31px;
	background: url('/shop/data/skin/standard/img/login_sns_facebook.gif') no-repeat;
}
