<?php /* Template_ 2.2.7 2014/07/23 17:03:45 /www/hummingimc_godo_co_kr/shop/data/skin/standard/goods/goods_qna.htm 000007156 */ 
...
<tr>
	<td><img src="/shop/data/skin/standard/img/common/title_qna.gif" border=0></td>
</tr>
<TR>
...
<tr>
	...
	<tr>
		<td><img src="/shop/data/skin/standard/img/common/search.gif" border=0></td>
		...
		<tr>
			...
			</select><input type="text" NAME="sword" value="<?php echo $_GET['sword']?>" size=47 class="linebg"><input type="image" src="/shop/data/skin/standard/img/common/btn_search.gif" align=absmiddle>
			</td>
		</tr>
		</table>
		</td>
...
<?php }elseif($TPL_V1["type"]=='N'){?>
	<td style="padding-left:5px;cursor:pointer;" onclick="view_content('<?php echo $TPL_V1["sno"]?>')"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["secretIcon"]){?>&nbsp;<img src="/shop/data/skin/standard/img/common/icn_secret.gif" align=absmiddle><?php }?></div></td>
<?php }?>
...
<a href="javascript:;" onclick="popup_register( 'add_qna', '' )"><img src="/shop/data/skin/standard/img/common/btn_qna.gif"></a>
</div>
