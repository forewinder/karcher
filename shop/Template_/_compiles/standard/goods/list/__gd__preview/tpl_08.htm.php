<?php /* Template_ 2.2.7 2015/12/28 15:21:51 /www/hummingimc_godo_co_kr/shop/data/skin/standard/goods/list/tpl_08.htm 000004911 */ 
...
<?php if($TPL_V1["oriPrice"]){?><strike><?php echo number_format($TPL_V1["oriPrice"])?></strike>↓<?php }?>
			<div style="padding-bottom:3px"><b><?php echo number_format($TPL_V1["goodsDiscountPrice"])?>원</b> <?php if($TPL_V1["special_discount_amount"]){?><img src="/shop/data/skin/standard/img/icon/goods_special_discount.gif"><?php }?></div>
<?php }else{?>
<?php if($TPL_V1["price"]){?>
