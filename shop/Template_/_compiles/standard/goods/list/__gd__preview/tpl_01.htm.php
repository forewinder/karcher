<?php /* Template_ 2.2.7 2015/12/28 15:21:51 /www/hummingimc_godo_co_kr/shop/data/skin/standard/goods/list/tpl_01.htm 000003865 */ 
...
<?php if($TPL_V1["oriPrice"]){?><a href="<?php echo $TPL_V1["goods_view_url"]?>" class="pname"><strike style="font-size:11px;"><?php echo number_format($TPL_V1["oriPrice"])?></strike>↓</a><?php }?>
			<div style="padding-bottom:3px;"><a href="<?php echo $TPL_V1["goods_view_url"]?>" class="pprice"><b><?php echo number_format($TPL_V1["goodsDiscountPrice"])?></b></a> <?php if($TPL_V1["special_discount_amount"]){?><img src="/shop/data/skin/standard/img/icon/goods_special_discount.gif"><?php }?></div>
<?php }else{?>
<?php if($TPL_V1["price"]){?>
