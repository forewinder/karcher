<?php /* Template_ 2.2.7 2016/04/12 08:47:09 /www/hummingimc_godo_co_kr/shop/data/skin/standard/outline/header/main.htm 000018910 */ ?>
<header>
<nav class="navbar">
...
<section id="user" class="navbar-right">
    <ul>
            ...
            <li id="product-basket-nav">
				<a href="#" class="hidden-sm hidden-xs shopping-cart" style="position: relative; display: inherit; height:38px;">
                    <span class="icon-shop">장바구니 </span><span class="badge" style="position: absolute; top: 2px; right: -25px;"><font><font>0</font></font></span>
                </a>
                
                <a href="#" class="shoplink visible-sm visible-xs hidden" style="position: relative; display: inherit;">
                    <span class="icon-shop"></span><span><font><font>장바구니 </font></font></span><span class="badge" style="margin-left: 6px;"><font><font>0</font></font></span>
                </a>
            </li>
        <li>
