<?php /* Template_ 2.2.7 2015/11/30 11:04:46 /www/hummingimc_godo_co_kr/shop/data/skin/standard/outline/header/standard.htm 000006240 */  $this->include_("dataBanner");?>
<a name="top"></a>
<div id="header_main">
...
<?php }else{?>
				...
				<li><img src="/shop/data/skin/standard/img/main/topmenu_bar.jpg"></li>
				<li><a href="<?php echo url("mypage/mypage.php?")?>&&" <?php if($TPL_VAR["useMypageLayerBox"]=='y'){?>onClick="return fnMypageLayerBox(<?php if($GLOBALS["sess"]){?>true<?php }?>);"<?php }?>><img src="/shop/data/skin/standard/img/main/topmenu_mypage.jpg"></a></li>
				<li><img src="/shop/data/skin/standard/img/main/topmenu_bar.jpg"></li>
<?php }?>
<?php }?>
