<?php /* Template_ 2.2.7 2016/02/05 10:39:07 /www/hummingimc_godo_co_kr/shop/data/skin/standard/outline/side/mypage.htm 000003137 */  $this->include_("dataBanner");?>
<div id="left_mypage" style="width:<?php echo $GLOBALS["cfg"]['shopSideSize']?>px;">
	...
	<!-- 마이페이지 메뉴 시작 -->
	<div style="width:100%; height:15px; border-bottom:solid 1px #E8E8E8; font-size:0px;"></div>
